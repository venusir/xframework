...
namespace XFramework.XSerialize
{
    ...
    /// <para>内置默认实现：<see cref="NewtonsoftSerializer"/>（基于 Newtonsoft.Json，format = "json"）；
    /// <see cref="JsonSerializer"/>（封装 Unity JsonUtility，format = "json-utility"）作为遗留格式保留。</para>
