...
<root>
  ...
  ├── Editor
  │   ├── Venusy609.Xframework.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Venusy609.Xframework.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Venusy609.Xframework.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Venusy609.Xframework.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Venusy609.Xframework`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package XFramework Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Venusy609.Xframework.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Venusy609.Xframework.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Venusy609.Xframework.Editor.Tests.asmdef`

  `Tests/Runtime/Venusy609.Xframework.Tests.asmdef`
...
Use the `Documentations~/XFramework.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
